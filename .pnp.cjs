...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "packageRegistryData": [\
      ...
      ["npm-package-example", [\
        ["npm:1.1.2", {\
          "packageLocation": "./.yarn/cache/npm-package-example-npm-1.1.2-52d88cc060-f560cdfcb2.zip/node_modules/npm-package-example/",\
          "packageDependencies": [\
            ["npm-package-example", "npm:1.1.2"]\
          ],\
          "linkType": "HARD"\
